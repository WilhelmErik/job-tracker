🗺️ Project Roadmap: Job Tracker
🚧 Phase 1: Core Functionality (Current Focus)
• Kanban Board UI: Create columns (Applied, Interviewing, Rejected, Offer).

• Drag & Drop: Implement ability to move job cards between columns.
...
• AI Integration (Gemini API):
  ...
  • Feature: "Smart Paste" (Extract job details from raw text).

  • Feature: "Vibe Check" (Compare resume vs. job description).

• Analytics: Simple chart showing applications per week.